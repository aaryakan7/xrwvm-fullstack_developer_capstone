...
let home_page_items =  <div>
  <a className="nav_link" href="/login" style={{marginRight: "15px", color: "black"}}>Login</a>
  <a className="nav_link" href="/register" style={{color: "black"}}>Register</a>
</div>
